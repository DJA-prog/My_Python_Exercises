...
def button_equal():
        ...
        for input_index in screen_input:
            if input_index == oper:
                ...
                if oper == "^":
                    ...
                    screen_input.pop(oper_index)
                    screen_input.pop(oper_index)
                    answer = calculate.power()
                    screen_input[oper_index - 1] = answer
                elif oper == ".inv":
                    calculate = Calcu(screen_input[oper_index - 1], "0")
                    screen_input.pop(oper_index)
                    screen_input.pop(oper_index)
                    answer = calculate.inverse()
                    screen_input[oper_index - 1] = answer
                elif oper == "*":
                    calculate = Calcu(screen_input[oper_index - 1], screen_input[oper_index + 1])
                    screen_input.pop(oper_index)
    ...
    history_index_max = 0
    new_data_id = next_id()
    data = ET.Element("calculation",
                      {"id": str(new_data_id),
                       "date": str(present_time.strftime('%d-%m-%Y')),
                       "time": str(present_time.strftime('%H-%M-%S')),
                       "equation": str(disp),
                       "answer": str(answer)})
...
Button(root, text="1", command=lambda: button_click(1), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=4,
                                                                                                           column=0)
Button(root, text="2", command=lambda: button_click(2), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=4,
                                                                                                           column=1)
Button(root, text="3", command=lambda: button_click(3), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=4,
                                                                                                           column=2)
Button(root, text="4", command=lambda: button_click(4), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=3,
                                                                                                           column=0)
Button(root, text="5", command=lambda: button_click(5), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=3,
                                                                                                           column=1)
Button(root, text="6", command=lambda: button_click(6), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=3,
                                                                                                           column=2)
Button(root, text="7", command=lambda: button_click(7), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=2,
                                                                                                           column=0)
Button(root, text="8", command=lambda: button_click(8), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=2,
                                                                                                           column=1)
Button(root, text="9", command=lambda: button_click(9), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=2,
                                                                                                           column=2)
Button(root, text="0", command=lambda: button_click(0), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=5,
                                                                                                           column=1)
...
Button(root, text="+", command=lambda: button_click("+"), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=2,
                                                                                                             column=3)
Button(root, text="-", command=lambda: button_click("-"), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=3,
                                                                                                             column=3)
Button(root, text="*", command=lambda: button_click("*"), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=4,
                                                                                                             column=3)
Button(root, text="/", command=lambda: button_click("/"), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=5,
                                                                                                             column=3)
Button(root, text="1/x", command=lambda: button_click(".inv"), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=6,
                                                                                                                  column=0)
Button(root, text="X^a", command=lambda: button_click("^"), bg='#173F5F', fg="#ED553B", width=6, pady=10).grid(row=6,
                                                                                                               column=1)
